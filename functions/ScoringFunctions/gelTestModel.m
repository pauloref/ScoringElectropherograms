function gelTestModel(obj,Distances,Threshold,CutOff,wavelet,WaveletThreshold)
%Scores using bagged trees. Bagged Trees were trained with gel test
...
load('model_gel_test_20.mat'); % load model
model = model_gel_test_20;
