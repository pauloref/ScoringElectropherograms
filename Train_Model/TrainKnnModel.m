function [trainedClassifier, peak_detection_accuracy] = TrainKnnModel(trainingData)
...
% Auto-generated by MATLAB on 17-Apr-2020 16:57:13
...
% Compute the peak detection accuracy
confusionM = confusionmat(response,validationPredictions);
peak_detection_accuracy = confusionM(2,2)/(confusionM(2,2)+confusionM(1,2)+confusionM(2,1));
